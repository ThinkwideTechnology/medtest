...
Only requiring some minor changes is medexcoin.cpp.
...
Changes to medexcoin.cpp
----------------------
medexcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
