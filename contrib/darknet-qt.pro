...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/medexcoin-cli.cpp \
           src/medexcoin-tx.cpp \
           src/medexcoind.cpp \
           src/db.cpp \
           ...
           src/qt/medexcoin.cpp \
           src/qt/medexcoinstrings.cpp \
...
RESOURCES += src/qt/medexcoin.qrc src/qt/medexcoin_locale.qrc

TRANSLATIONS += src/qt/locale/medexcoin_bg.ts \
                src/qt/locale/medexcoin_de.ts \
                src/qt/locale/medexcoin_en.ts \
                src/qt/locale/medexcoin_es.ts \
                src/qt/locale/medexcoin_fi.ts \
                src/qt/locale/medexcoin_fr.ts \
                src/qt/locale/medexcoin_it.ts \
                src/qt/locale/medexcoin_ja.ts \
                src/qt/locale/medexcoin_pl.ts \
                src/qt/locale/medexcoin_pt.ts \
                src/qt/locale/medexcoin_ru.ts \
                src/qt/locale/medexcoin_sk.ts \
                src/qt/locale/medexcoin_sv.ts \
                src/qt/locale/medexcoin_vi.ts \
                src/qt/locale/medexcoin_zh_CN.ts \
                src/qt/locale/medexcoin_zh_TW.ts
