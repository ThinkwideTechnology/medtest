...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Medexcoin Core medexcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  medexcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded medexcoin transaction") + "\n" +
              "  medexcoin-tx [options] -create [commands]   " + _("Create hex-encoded medexcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded medexcoin transaction
