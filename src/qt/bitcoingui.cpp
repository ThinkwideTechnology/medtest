    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Medexcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Medexcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and medexcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Medexcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Medexcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Medexcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Medexcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Medexcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Medexcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Medexcoin Core help message to get a list with possible Medexcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Medexcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Medexcoin network", "", count));
}
...
{
    QString strTitle = tr("Medexcoin Core"); // default title
