...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Medexcoin Core"),
     ...
     * override -datadir in the medexcoin.conf file in the default data directory
     * (to be consistent with medexcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
