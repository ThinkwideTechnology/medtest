    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Medexcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Medexcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  medexcoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Medexcoin Core is shutting down...") + "<br /><br />" +
