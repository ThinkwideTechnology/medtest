    ...
    fProxyIpValid(true)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MDEX-dark"), QVariant("drk"));
    ui->theme->addItem(QString("MDEX-dark-1"), QVariant("drk-1"));
    ui->theme->addItem(QString("MDEX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MDEX-traditional"), QVariant("trad"));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->anonymizeMedexcoin, OptionsModel::AnonymizeMedexcoinAmount);
