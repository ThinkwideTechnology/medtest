...
#if defined(NDEBUG)
# error "Medexcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Medexcoin Signed Message:\n";
...
int64_t GetBlockValue(int nBits, int nHeight, const CAmount& nFees)
{
    ...
    else if(nHeight < 1000 && nHeight > 10) {
        nSubsidy = 0; 
    }
    else if(nHeight < 1000000 && nHeight > 500) {
        nSubsidy = 5 * COIN; 
    } else {
        nSubsidy = 0;
    }
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue)
{
    ...
    else if(nHeight < LAST_POW_BLOCK && nHeight > 10) {
        ret = 0;
    }
    else if(nHeight > LAST_POW_BLOCK && nHeight < 1000000) 
    {
...
void ThreadScriptCheck() {
    RenameThread("medexcoin-scriptch");
